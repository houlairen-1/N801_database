function ensemble2_mix_3(cover_features_path_1,cover_features_path_2, ...
                       cover_features_path_3,stego_features_path_1, ...
                       stego_features_path_2,stego_features_path_3, ...
...
%% C1-C2-C3-S1-S2-S3
    ...
    % log
    log_file = fullfile(log_dir, [cover_features_name_1 '_and_' cover_features_name_2 '_and_' cover_features_name_3 '_vs_' ...
                        stego_features_name_1 '_and_' stego_features_name_2 '_and_' stego_features_name_3 '_r' num2str(repeated_times) ...
                        '.log']);
    ...
    names_c = intersect(intersect(cover_1.names,cover_2.names), cover_3.names);
    names_s = intersect(intersect(stego_1.names,stego_2.names), stego_3.names);
    ...
    for seed=init_seed:init_seed+repeated_times-1
        ...
        TRN_cover = [C1(training_set,:); C2(training_set,:); C3(training_set,:)];
        TRN_stego = [S1(training_set,:); S2(training_set,:); S3(training_set,:)];
        
        % Prepare testing features
        TST_cover = [C1(testing_set,:); C2(testing_set,:); C3(testing_set,:)];
        TST_stego = [S1(testing_set,:); S2(testing_set,:); S3(testing_set,:)];
