...
% stego
for dir_no = 20:20:40
    diary(['../../log/BOSS_AHD_LAN2_HILLCMDC_', num2str(dir_no), '_SGRM.log']);
    diary on;
    cur_dir = ['/home/lgq/BOSS_AHD_all/BOSS_AHD_LAN2_all/HILL_CMD_C/' ...
               'BOSS_AHD_LAN2_HILLCMDC_', num2str(dir_no)];
    t_file = ['../../data/AHD/HILL_CMD_C/BOSS_AHD_LAN2_HILLCMDC_', num2str(dir_no), '_SGRM'];
    MEXstart = tic;
